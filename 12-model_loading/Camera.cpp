...
void Camera::setCameraPosition(const Vector3f& pos)
{
	_position = pos;
}
...
void Camera::setCameraUpDirection(const Vector3f& up)
{
	_up = up;
}

void Camera::setCameraTarget(const Vector3f& tgt)
{
	_target = tgt;
	_target.Normalize();
}
