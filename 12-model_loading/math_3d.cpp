...
Vector2f::Vector2f(float xF, float yF) : x(xF), y(yF)
{
}
...
Vector3f::Vector3f(float xF, float yF, float zF) : x(xF), y(yF),z(zF)
{
}
...
Vector4f::Vector4f(Vector3f v, float w) : x(v.getX()), y(v.getY()), z(v.getZ()), w(w)
{
}
